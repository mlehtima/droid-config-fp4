= SAILFISH OS FOR FAIRPHONE 4 FLASHING GUIDE =

= FOR LINUX, WINDOWS AND OS X =

= STEP 1: GETTING AN FAIRPHONE 4 =
...
Make sure that the system language of your Fairphone 4 device is set to English
before you continue.
...
= STEP 3 : FLASHING SAILFISH OS TO YOUR FAIRPHONE 4 =
...
* While holding the 'Volume Down' button, connect the other end of the USB cable
  to your Fairphone 4 device. You should see fastboot mode on display.
